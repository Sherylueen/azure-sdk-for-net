...
namespace Azure.ResourceManager.AppComplianceAutomation.Models
{
    ...
    public static partial class ArmAppComplianceAutomationModelFactory
    {
        ...
        {
            return new GetCollectionCountResponse(count);
        }
        ...
        public static GetOverviewStatusResponse GetOverviewStatusResponse(IEnumerable<StatusItem> statusList = null)
        {
            ...
            return new GetOverviewStatusResponse(statusList?.ToList());
        }
        ...
        {
            return new StatusItem(statusName, statusValue);
        }
        ...
        /// <returns> A new <see cref="Models.OnboardResponse"/> instance for mocking. </returns>
        public static OnboardResponse OnboardResponse(IEnumerable<string> subscriptionIds = null)
        {
            subscriptionIds ??= new List<string>();

            return new OnboardResponse(subscriptionIds?.ToList());
        }
        ...
        /// <returns> A new <see cref="Models.TriggerEvaluationResponse"/> instance for mocking. </returns>
        public static TriggerEvaluationResponse TriggerEvaluationResponse(TriggerEvaluationProperty properties = null)
        {
            return new TriggerEvaluationResponse(properties);
        }

        /// <summary> Initializes a new instance of TriggerEvaluationProperty. </summary>
        ...
        public static TriggerEvaluationProperty TriggerEvaluationProperty(DateTimeOffset? triggerOn = null, DateTimeOffset? evaluationEndOn = null, IEnumerable<string> resourceIds = null, IEnumerable<QuickAssessment> quickAssessments = null)
        {
            ...
            return new TriggerEvaluationProperty(triggerOn, evaluationEndOn, resourceIds?.ToList(), quickAssessments?.ToList());
        }
        ...
        public static QuickAssessment QuickAssessment(string resourceId = null, string responsibilityId = null, DateTimeOffset? timestamp = null, ResourceStatus? resourceStatus = null, string displayName = null, string description = null, string remediationLink = null)
        {
            return new QuickAssessment(resourceId, responsibilityId, timestamp, resourceStatus, displayName, description, remediationLink);
        }
        ...
        public static ListInUseStorageAccountsResponse ListInUseStorageAccountsResponse(IEnumerable<StorageInfo> storageAccountList = null)
        {
            ...
            return new ListInUseStorageAccountsResponse(storageAccountList?.ToList());
        }
        ...
        public static ReportProperties ReportProperties(string id = null, ReportStatus? status = null, Guid? tenantId = null, string reportName = null, string offerGuid = null, string timeZone = null, DateTimeOffset? triggerOn = null, DateTimeOffset? nextTriggerOn = null, DateTimeOffset? lastTriggerOn = null, IEnumerable<string> subscriptions = null, IEnumerable<ResourceMetadata> resources = null, OverviewStatus complianceStatusM365 = null, StorageInfo storageInfo = null, IEnumerable<CertSyncRecord> certRecords = null, ProvisioningState? provisioningState = null)
        {
            subscriptions ??= new List<string>();
            resources ??= new List<ResourceMetadata>();
            certRecords ??= new List<CertSyncRecord>();

            return new ReportProperties(id, status, tenantId, reportName, offerGuid, timeZone, triggerOn, nextTriggerOn, lastTriggerOn, subscriptions?.ToList(), resources?.ToList(), complianceStatusM365 != null ? new ReportComplianceStatus(complianceStatusM365) : null, storageInfo, certRecords?.ToList(), provisioningState);
        }
        ...
        {
            return new OverviewStatus(passedCount, failedCount, manualCount, notApplicableCount, pendingCount);
        }
        ...
        {
            return new WebhookResourceData(id, name, resourceType, systemData, properties);
        }
        ...
        public static WebhookProperties WebhookProperties(string webhookId = null, string webhookName = null, WebhookStatus? status = null, Guid? tenantId = null, SendAllEvent? sendAllEvents = null, IEnumerable<NotificationEvent> events = null, Uri payloadUri = null, ContentType? contentType = null, string webhookKey = null, UpdateWebhookKey? updateWebhookKey = null, WebhookKeyEnabled? webhookKeyEnabled = null, EnableSslVerification? enableSslVerification = null, WebhookPropertiesDeliveryStatus? deliveryStatus = null, ProvisioningState? provisioningState = null)
        {
            events ??= new List<NotificationEvent>();

            return new WebhookProperties(webhookId, webhookName, status, tenantId, sendAllEvents, events?.ToList(), payloadUri, contentType, webhookKey, updateWebhookKey, webhookKeyEnabled, enableSslVerification, deliveryStatus, provisioningState);
        }
        ...
        public static Category Category(string categoryName = null, CategoryStatus? categoryStatus = null, IEnumerable<ControlFamily> controlFamilies = null)
        {
            ...
            return new Category(categoryName, categoryStatus, controlFamilies?.ToList());
        }
        ...
        public static ControlFamily ControlFamily(string controlFamilyName = null, ControlFamilyStatus? controlFamilyStatus = null, IEnumerable<Control> controls = null)
        {
            ...
            return new ControlFamily(controlFamilyName, controlFamilyStatus, controls?.ToList());
        }
        ...
        public static Control Control(string controlId = null, string controlName = null, string controlFullName = null, string controlDescription = null, string controlDescriptionHyperLink = null, ControlStatus? controlStatus = null, IEnumerable<Responsibility> responsibilities = null)
        {
            ...
            return new Control(controlId, controlName, controlFullName, controlDescription, controlDescriptionHyperLink, controlStatus, responsibilities?.ToList());
        }

        /// <summary> Initializes a new instance of Responsibility. </summary>
        ...
        public static Responsibility Responsibility(string responsibilityId = null, string responsibilityTitle = null, string responsibilityDescription = null, ResponsibilityType? responsibilityType = null, ResponsibilitySeverity? responsibilitySeverity = null, ResponsibilityStatus? responsibilityStatus = null, ResponsibilityEnvironment? responsibilityEnvironment = null, int? failedResourceCount = null, int? totalResourceCount = null, IEnumerable<ResponsibilityResource> resourceList = null, IEnumerable<Recommendation> recommendationList = null, string guidance = null, string justification = null, IEnumerable<string> evidenceFiles = null)
        {
            ...
            return new Responsibility(responsibilityId, responsibilityTitle, responsibilityDescription, responsibilityType, responsibilitySeverity, responsibilityStatus, responsibilityEnvironment, failedResourceCount, totalResourceCount, resourceList?.ToList(), recommendationList?.ToList(), guidance, justification, evidenceFiles?.ToList());
        }
        ...
        public static ResponsibilityResource ResponsibilityResource(string resourceId = null, string accountId = null, string resourceType = null, ResourceOrigin? resourceOrigin = null, ResourceStatus? resourceStatus = null, DateTimeOffset? resourceStatusChangeOn = null, IEnumerable<string> recommendationIds = null)
        {
            ...
            return new ResponsibilityResource(resourceId, accountId, resourceType, resourceOrigin, resourceStatus, resourceStatusChangeOn, recommendationIds?.ToList());
        }
        ...
        public static Recommendation Recommendation(string recommendationId = null, string recommendationShortName = null, IEnumerable<RecommendationSolution> recommendationSolutions = null)
        {
            ...
            return new Recommendation(recommendationId, recommendationShortName, recommendationSolutions?.ToList());
        }
        ...
        {
            return new RecommendationSolution(recommendationSolutionIndex, recommendationSolutionContent, isRecommendSolution);
        }
        ...
        {
            return new ComplianceReportItem(categoryName, controlFamilyName, controlId, controlName, controlStatus, responsibilityTitle, responsibilityDescription, resourceId, resourceType, resourceOrigin, resourceStatus, resourceStatusChangeOn);
        }
        ...
        {
            return new EvidenceResourceData(id, name, resourceType, systemData, properties);
        }
        ...
        public static EvidenceProperties EvidenceProperties(EvidenceType? evidenceType = null, string evidenceName = null, string filePath = null, string controlId = null, string responsibilityId = null, string reportName = null, ProvisioningState? provisioningState = null)
        {
            return new EvidenceProperties(evidenceType, evidenceName, filePath, controlId, responsibilityId, reportName, provisioningState);
        }
        ...
        public static EvidenceFileDownloadResponse EvidenceFileDownloadResponse(Uri evidenceFileUri = null)
        {
            return new EvidenceFileDownloadResponse(evidenceFileUri != null ? new EvidenceFileDownloadResponseEvidenceFile(evidenceFileUri) : null);
        }
    }
}
